			  ...
			  <div class="col-lg-12 col-sm-12">
			   <h2 class="text-center">New Post</h2>
				 ...
				 <?php
					 ...
					 $cat_id=$_GET['cid'];
					 $sql="select * from waiz where category='$cat_id' ";
		  ...
		  <br>
		   ...
		   <div id="footer-sidebar">
			  ...
			  <div id="footer">
			    ...
			    <div class="row">
				  <div class="col-md-6"><p><i class="fa fa-copyright" aria-hidden="true"></i>  Copy Right 2021:All Right Reserved,Founded by Waiz<a href="index.php">Assamnaturalpic.com</a> </p></div>
				  <div class="col-md-6">
